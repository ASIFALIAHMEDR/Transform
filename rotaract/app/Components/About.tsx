...
export default function About() {
  return (
  <>
  <section className="py-10 lg:py-20 bg-stone-100 font-poppins dark:bg-gray-800" id='about'>
        <div className="max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            <div className="flex flex-wrap ">
                ...
                <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <Image src="/pexel.jpg" alt="" width={1000} height={1000} className="relative z-40 object-cover w-full h-full rounded"/>
                </div>
            </div>
        </div>
    </section>
